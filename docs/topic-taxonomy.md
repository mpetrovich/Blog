...
| `leadership` | Managing people, teams, delegation, high-impact traits | Solo craft or personal health only |
...
| `health` | Burnout, sustainability, energy at work | Ordinary career reflection without strain/recovery |
| `books` | Book summaries / learning synthesis from a specific book | Posts that merely cite a book in passing |

Intentionally omitted: `learning`, `readme`, `management` (use `leadership`), `quality`, `strategy`.
...
| [To The Brink Of Burnout And Back Again](../posts/published/to-the-brink-of-burnout-and-back-again.md) | `health`, `career` |
